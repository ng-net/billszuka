...
ENRICHMENTS = {
    ...
    "RO-A-010": {"action": "ENRICH", "nazwa_firmy": "Vaper's Paradise SRL (vapersparadise.ro)", "www": "https://vapersparadise.ro", "adres": "Șoseaua Virtuții 148, Sector 6, București", "miasto": "București", "email": "contact@vapersparadise.ro", "flagi": "🟡 DO-WERYFIKACJI (brak CUI)", "zrodlo_danych": "vapersparadise.ro | Google Maps", "notatki": "Sklep vape i akcesoria w Bukareszcie. CUI niezidentyfikowane w publicznym ONRC — wymaga bezpośredniej weryfikacji."},
    "RO-A-011": {"action": "ENRICH", "nazwa_firmy": "ELVAPO EXPRES SRL", "nip_vat": "RO45731590", "rejestr_id": "J2022003993408", "www": "https://elvapo.ro", "adres": "Splaiul Independenței 202B ap. 42, Sector 6, București", "miasto": "București", "email": "contact@elvapo.ro", "flagi": "✅ FROZEN (ONRC)", "zrodlo_danych": "ONRC / termene.ro J2022003993408 | elvapo.ro", "notatki": "Sklep vape i e-papierosy w Bukareszcie. Nowoczesny e-commerce."},
    "RO-A-012": {"action": "ENRICH", "nazwa_firmy": "SMOKE MANIA ONLINE SRL (Smokemania)", "nip_vat": "RO33296493", "rejestr_id": "J40/7257/2014", "www": "https://smokemania.ro", "adres": "Str. Știrbei Vodă 126C, Sector 1, București", "miasto": "București", "email": "contact@smokemania.ro", "telefon": "+40 21 300 0000", "flagi": "✅ FROZEN (ONRC)", "zrodlo_danych": "ONRC J40/7257/2014 | smokemania.ro", "notatki": "Sieć salonów i e-commerce Smokemania — jeden z największych rumuńskich sieci vape i akcesoriów."},
    ...
    "EE-A-006": {"action": "ENRICH", "nazwa_firmy": "S.W.P. Distribution OÜ (Snus Empire)", "nip_vat": "", "rejestr_id": "14669735", "www": "https://snusempire.ee", "adres": "Pärnu mnt 18, 10141 Tallinn", "miasto": "Tallinn", "email": "info@snusempire.ee", "flagi": "✅ FROZEN (e-äriregister EE)", "zrodlo_danych": "ariregister.rik.ee | snusempire.ee | inforegister.ee", "notatki": "Estońska sieć salonów Snus Empire i dystrybutor snus/nikotyna/akcesoria."},
    "EE-A-007": {"action": "ENRICH", "nazwa_firmy": "Vape Group OÜ (VeipLux)", "nip_vat": "", "rejestr_id": "12953082", "www": "https://veiplux.ee", "adres": "Vesivärava tn 50-203, 10152 Tallinn", "miasto": "Tallinn", "email": "info@veiplux.ee", "flagi": "✅ FROZEN (e-äriregister EE)", "zrodlo_danych": "ariregister.rik.ee | inforegister.ee", "notatki": "Estońska sieć salonów vape VeipLux (Vape Group OÜ). Dystrybutor e-papierosów."},
    ...
    for fpath in catalog_files:
        ...
        for row in rows:
            ...
            if spec["action"] == "REMOVE":
                total_removed += 1
                changed = True
                print(f"  🗑️  REMOVED {rid}: {row.get('nazwa_firmy','')[:50]} — {spec['reason'][:80]}")
                continue
                ...
                print(f"  ✅ ENRICHED {rid}: {row.get('nazwa_firmy','')[:50]}")
                new_rows.append(row)
